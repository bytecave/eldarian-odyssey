...
The historical x86 project targets are retained, but x86 and non-Windows builds have not been validated in this migration. See [the September 2026 review and manual regression guide](REVIEW-2026-09.md) for results, remaining limitations, and a complete test walkthrough. **That guide and the regression test source contain major game spoilers.**
