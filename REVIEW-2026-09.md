...
| Regression executable | **206 checks, 0 failures** |
...
| Guard says “kneel ... nave” TODO | **Obsolete for current text.** That reported line is not present in the current guard response; no speculative rewrite. |
